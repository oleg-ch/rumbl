defmodule Rumbl.Multimedia do
  ...
  def list_user_videos(%Accounts.User{} = user) do
    # WTF????? why Video..., it is a fucking MODULE!!! How come it becomes a query?...
    # because Video (like any other Ecto.Schema)
    # implements the so-called Ecto.Queryable protocol
    # and hence may act as a query
    Video
